...
class spectrocoin extends base{
    ...
    protected static $options = array(
        ...
        array(
            ...
            'configuration_value' => '***',
            'configuration_description' => 'In case the fee is paid by the client, the fee amount will be added to the total price of the item/service. E.g item/service price is 100 USD and the fee is 0.5% then the client will pay 100.5 USD. You will receive the full item price – 100 USD. In case the fee is paid by you, the fee will be deducted from the total item price, hence you will receive 99.5 USD.',
            'configuration_group_id' => '6',
            'sort_order' => '0',
        ...
        array(
            'configuration_title' => 'Spectrocoin payment method',
            'configuration_key' => 'MODULE_PAYMENT_SPECTROCOIN_PAYMENT_METHOD',
            'configuration_value' => 'BTC',
            'configuration_description' => 'Choose the method for the payment',
            'configuration_group_id' => '6',
            'sort_order' => '0',
